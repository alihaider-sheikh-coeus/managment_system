 ...
 */
final class Version20210726132337 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reviews ADD CONSTRAINT FK_6970EB0F9D86650F FOREIGN KEY (user_id_id) REFERENCES users (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE reviews ADD CONSTRAINT FK_6970EB0FB852C405 FOREIGN KEY (shop_id_id) REFERENCES shops (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
